 ...
 */
public class HypervolumeConc<Evaluate extends List<? extends Solution<?>>>
    extends SimpleDescribedEntity
    implements QualityIndicator<Evaluate,Double> {

  private Front referenceParetoFront ;

  public HypervolumeConc() {
   ...
   */
  public HypervolumeConc(String referenceParetoFrontFile) throws FileNotFoundException {
    this() ;
   ...
   * @throws FileNotFoundException
   */
  public HypervolumeConc(Front referenceParetoFront) {
    this() ;
